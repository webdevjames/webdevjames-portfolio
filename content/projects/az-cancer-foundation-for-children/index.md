---
title: "AZ Cancer Foundation for Children"
category: ""
heroImage: "/webdevjames-project-banner-az-cancer-foundation.jpg"
heroPosition: "top center"
blurb: "ACFC offers a place where kids with cancer can be kids."
description: "Social, emotional, and financial support for families facing the unthinkable. Chrisie Abramo's powerful story is one that needed to be told. Out of her tragedy, she did what most could not - she turned her grief into hope and support for others facing a similar situation."
specs:
  - "WordPress"
...
Talk about a worthy cause... AZ Cancer Foundation was looking to revitalize their branding and website. This new initiative would raise awareness of their existence and promote their availability to help families in this difficult space. They wanted to provide more information to families facing a diagnosis, inform families of next steps in the process, and be a haven for families in need of support. They also wanted to promote fundraiser events.
...
:project-button{link="https://azcancerfoundation.org/" text="Visit Site"}
::
...
#half-description
The site was built with the idea that families of all experiences will have an easy time navigating the site to find exactly what they're looking for. Navigation menus with "Who We Are", "What We Do", and "Family Inquiry" aren't anything groundbreaking, but they are a simple for all users to understand. Simplicity was the idea. In the same vein, the Advanced Custom Fields for the Admin area of the site made content entry simple, standardized, and easy for their team to find and manage.
::
